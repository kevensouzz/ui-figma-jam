...
const Square = ({ selected }: NodeProps) => {
  return (
    <div className="bg-violet-500 rounded w-full h-full min-w-[100px] min-h-[100px] ">
      ...
      <NodeResizer minWidth={100} minHeight={100} isVisible={selected} lineClassName="border-blue-400" handleClassName="h-3 w-3 bg-white border-2 rounded border-blue-400" />
